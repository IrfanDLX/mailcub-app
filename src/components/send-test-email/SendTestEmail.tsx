  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Compose and send test emails to verify your setup</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="ml-2 text-sm text-gray-700">HTML Format</span>
                  </label>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-600">Available Senders</span>
                </div>
                <span className="font-semibold text-gray-900">
                  {emailAccounts.filter(a => a.status === 'active').length}
                </span>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-blue-900 mb-3">Sending Tips</h3>
