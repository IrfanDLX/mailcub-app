    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage your API keys for accessing MailCub services</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600">Keep your API keys secure and never share them publicly</p>
        </div>
        ...
        {apiKeys.length === 0 && (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">Create your first API key to start using MailCub services</p>
            <button
              onClick={handleAddApiKey}
              className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
            >
